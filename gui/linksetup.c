...
{
	GtkWidget *dlg, *lbl, *vbox, *vbox2, *hbox, *frame;
	...
	gtk_widget_set_halign(lsdlg.grd, GTK_ALIGN_CENTER);
	gtk_widget_set_valign(lsdlg.grd, GTK_ALIGN_CENTER);
	gtk_box_pack_start(GTK_BOX(vbox2), lsdlg.grd, FALSE, FALSE, 0);
